...
print(f'당신의 키는 사실상 { round(height, -1) }cm 입니다.')
...
# 두 사용자의 이름을 꺼내보자. => list / tuple 모두 넣어준 순서 (index) 가 자료를 꺼낼때 중요한 기준.
# user_info[0] 
# user_info2[2]
...
# dictionary는 순서는 중요하지 않다. => 이름표가 어떤게 붙어있느냐?
